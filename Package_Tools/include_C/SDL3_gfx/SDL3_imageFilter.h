...
extern "C" {
	...
	//  SDL_imageFilterShiftRightAndMultByByte: D = saturation255((S >> N) * C)
	 int SDL_imageFilterShiftRightAndMultByByte(unsigned char *Src1, unsigned char *Dest, unsigned int length,
	...
	//  SDL_imageFilterBinarizeUsingThreshold: D = S >= T ? 255:0
	 int SDL_imageFilterBinarizeUsingThreshold(unsigned char *Src1, unsigned char *Dest, unsigned int length,
		unsigned char T);
	...
	//  SDL_imageFilterNormalizeLinear: D = saturation255((Nmax - Nmin)/(Cmax - Cmin)*(S - Cmin) + Nmin)
	 int SDL_imageFilterNormalizeLinear(unsigned char *Src, unsigned char *Dest, unsigned int length, int Cmin,
