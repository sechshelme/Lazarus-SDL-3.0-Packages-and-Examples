...
function SDLTest_CompareSurfacesIgnoreTransparentPixels(surface: PSDL_Surface; referenceSurface: PSDL_Surface; allowable_error: Integer): Integer; cdecl; external;
