...
package SDL3_SDL_mouse_h is

   SDL_BUTTON_LEFT : constant := 1;  --  /usr/local/include/SDL3/SDL_mouse.h:161
   SDL_BUTTON_MIDDLE : constant := 2;  --  /usr/local/include/SDL3/SDL_mouse.h:162
   SDL_BUTTON_RIGHT : constant := 3;  --  /usr/local/include/SDL3/SDL_mouse.h:163
   SDL_BUTTON_X1 : constant := 4;  --  /usr/local/include/SDL3/SDL_mouse.h:164
   SDL_BUTTON_X2 : constant := 5;  --  /usr/local/include/SDL3/SDL_mouse.h:165
   --  arg-macro: function SDL_BUTTON_MASK (X)
   --    return 2 ** ((X)-1);
   --  unsupported macro: SDL_BUTTON_LMASK SDL_BUTTON_MASK(SDL_BUTTON_LEFT)
   --  unsupported macro: SDL_BUTTON_MMASK SDL_BUTTON_MASK(SDL_BUTTON_MIDDLE)
   --  unsupported macro: SDL_BUTTON_RMASK SDL_BUTTON_MASK(SDL_BUTTON_RIGHT)
   --  unsupported macro: SDL_BUTTON_X1MASK SDL_BUTTON_MASK(SDL_BUTTON_X1)
   --  unsupported macro: SDL_BUTTON_X2MASK SDL_BUTTON_MASK(SDL_BUTTON_X2)
  ...
  --  
   ...
   subtype SDL_MouseID is SDL3_SDL_stdinc_h.Uint32;  -- /usr/local/include/SDL3/SDL_mouse.h:81
  ...
  --  
   ...
   with Convention => C;  -- /usr/local/include/SDL3/SDL_mouse.h:97
  ...
  --  
   ...
   with Convention => C;  -- /usr/local/include/SDL3/SDL_mouse.h:127
  ...
  --*< The surface data for this frame  
   type SDL_CursorFrameInfo is record
      surface : access SDL3_SDL_surface_h.SDL_Surface;  -- /usr/local/include/SDL3/SDL_mouse.h:140
      duration : aliased SDL3_SDL_stdinc_h.Uint32;  -- /usr/local/include/SDL3/SDL_mouse.h:141
   end record
   with Convention => C_Pass_By_Copy;  -- /usr/local/include/SDL3/SDL_mouse.h:138
  ...
  --  
   ...
   subtype SDL_MouseButtonFlags is SDL3_SDL_stdinc_h.Uint32;  -- /usr/local/include/SDL3/SDL_mouse.h:159
  ...
  --  
   ...
   type SDL_MouseMotionTransformCallback is access procedure
        (arg1 : System.Address;
         arg2 : SDL3_SDL_stdinc_h.Uint64;
         arg3 : access SDL3_SDL_video_h.SDL_Window;
         arg4 : SDL_MouseID;
         arg5 : access float;
         arg6 : access float)
   with Convention => C;  -- /usr/local/include/SDL3/SDL_mouse.h:205
  ...
  --  
   ...
   function SDL_HasMouse return Extensions.bool  -- /usr/local/include/SDL3/SDL_mouse.h:226
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetMice (count : access int) return access SDL_MouseID  -- /usr/local/include/SDL3/SDL_mouse.h:249
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetMouseNameForID (instance_id : SDL_MouseID) return Interfaces.C.Strings.chars_ptr  -- /usr/local/include/SDL3/SDL_mouse.h:266
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetMouseFocus return access SDL3_SDL_video_h.SDL_Window  -- /usr/local/include/SDL3/SDL_mouse.h:277
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetMouseState (x : access float; y : access float) return SDL_MouseButtonFlags  -- /usr/local/include/SDL3/SDL_mouse.h:310
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetGlobalMouseState (x : access float; y : access float) return SDL_MouseButtonFlags  -- /usr/local/include/SDL3/SDL_mouse.h:347
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetRelativeMouseState (x : access float; y : access float) return SDL_MouseButtonFlags  -- /usr/local/include/SDL3/SDL_mouse.h:382
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_WarpMouseInWindow
     (window : access SDL3_SDL_video_h.SDL_Window;
      x : float;
      y : float)  -- /usr/local/include/SDL3/SDL_mouse.h:405
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_WarpMouseGlobal (x : float; y : float) return Extensions.bool  -- /usr/local/include/SDL3/SDL_mouse.h:430
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_SetRelativeMouseTransform (callback : SDL_MouseMotionTransformCallback; userdata : System.Address) return Extensions.bool  -- /usr/local/include/SDL3/SDL_mouse.h:448
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_SetWindowRelativeMouseMode (window : access SDL3_SDL_video_h.SDL_Window; enabled : Extensions.bool) return Extensions.bool  -- /usr/local/include/SDL3/SDL_mouse.h:476
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetWindowRelativeMouseMode (window : access SDL3_SDL_video_h.SDL_Window) return Extensions.bool  -- /usr/local/include/SDL3/SDL_mouse.h:490
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CaptureMouse (enabled : Extensions.bool) return Extensions.bool  -- /usr/local/include/SDL3/SDL_mouse.h:538
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CreateCursor
     (data : access SDL3_SDL_stdinc_h.Uint8;
      mask : access SDL3_SDL_stdinc_h.Uint8;
      w : int;
      h : int;
      hot_x : int;
      hot_y : int) return access SDL_Cursor  -- /usr/local/include/SDL3/SDL_mouse.h:585
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CreateColorCursor
     (surface : access SDL3_SDL_surface_h.SDL_Surface;
      hot_x : int;
      hot_y : int) return access SDL_Cursor  -- /usr/local/include/SDL3/SDL_mouse.h:622
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CreateAnimatedCursor
     (frames : access SDL_CursorFrameInfo;
      frame_count : int;
      hot_x : int;
      hot_y : int) return access SDL_Cursor  -- /usr/local/include/SDL3/SDL_mouse.h:672
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CreateSystemCursor (id : SDL_SystemCursor) return access SDL_Cursor  -- /usr/local/include/SDL3/SDL_mouse.h:690
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_SetCursor (cursor : access SDL_Cursor) return Extensions.bool  -- /usr/local/include/SDL3/SDL_mouse.h:710
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCursor return access SDL_Cursor  -- /usr/local/include/SDL3/SDL_mouse.h:726
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetDefaultCursor return access SDL_Cursor  -- /usr/local/include/SDL3/SDL_mouse.h:741
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_DestroyCursor (cursor : access SDL_Cursor)  -- /usr/local/include/SDL3/SDL_mouse.h:760
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_ShowCursor return Extensions.bool  -- /usr/local/include/SDL3/SDL_mouse.h:775
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_HideCursor return Extensions.bool  -- /usr/local/include/SDL3/SDL_mouse.h:790
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CursorVisible return Extensions.bool  -- /usr/local/include/SDL3/SDL_mouse.h:805
   with Import => True, 
        Convention => C, 
        External_Name => "SDL_CursorVisible";

  -- Ends C function definitions when using C++  
end SDL3_SDL_mouse_h;
