...
package inttypes_h is
   ...
   SCNd8 : aliased constant String := "hhd" & ASCII.NUL;  --  /usr/include/inttypes.h:210
   SCNd16 : aliased constant String := "hd" & ASCII.NUL;  --  /usr/include/inttypes.h:211
   SCNd32 : aliased constant String := "d" & ASCII.NUL;  --  /usr/include/inttypes.h:212
   --  unsupported macro: SCNd64 __PRI64_PREFIX "d"

   SCNdLEAST8 : aliased constant String := "hhd" & ASCII.NUL;  --  /usr/include/inttypes.h:215
   SCNdLEAST16 : aliased constant String := "hd" & ASCII.NUL;  --  /usr/include/inttypes.h:216
   SCNdLEAST32 : aliased constant String := "d" & ASCII.NUL;  --  /usr/include/inttypes.h:217
   --  unsupported macro: SCNdLEAST64 __PRI64_PREFIX "d"

   SCNdFAST8 : aliased constant String := "hhd" & ASCII.NUL;  --  /usr/include/inttypes.h:220
   ...
   SCNi8 : aliased constant String := "hhi" & ASCII.NUL;  --  /usr/include/inttypes.h:226
   SCNi16 : aliased constant String := "hi" & ASCII.NUL;  --  /usr/include/inttypes.h:227
   SCNi32 : aliased constant String := "i" & ASCII.NUL;  --  /usr/include/inttypes.h:228
   --  unsupported macro: SCNi64 __PRI64_PREFIX "i"

   SCNiLEAST8 : aliased constant String := "hhi" & ASCII.NUL;  --  /usr/include/inttypes.h:231
   SCNiLEAST16 : aliased constant String := "hi" & ASCII.NUL;  --  /usr/include/inttypes.h:232
   SCNiLEAST32 : aliased constant String := "i" & ASCII.NUL;  --  /usr/include/inttypes.h:233
   --  unsupported macro: SCNiLEAST64 __PRI64_PREFIX "i"

   SCNiFAST8 : aliased constant String := "hhi" & ASCII.NUL;  --  /usr/include/inttypes.h:236
   ...
   SCNu8 : aliased constant String := "hhu" & ASCII.NUL;  --  /usr/include/inttypes.h:242
   SCNu16 : aliased constant String := "hu" & ASCII.NUL;  --  /usr/include/inttypes.h:243
   SCNu32 : aliased constant String := "u" & ASCII.NUL;  --  /usr/include/inttypes.h:244
   --  unsupported macro: SCNu64 __PRI64_PREFIX "u"

   SCNuLEAST8 : aliased constant String := "hhu" & ASCII.NUL;  --  /usr/include/inttypes.h:247
   SCNuLEAST16 : aliased constant String := "hu" & ASCII.NUL;  --  /usr/include/inttypes.h:248
   SCNuLEAST32 : aliased constant String := "u" & ASCII.NUL;  --  /usr/include/inttypes.h:249
   --  unsupported macro: SCNuLEAST64 __PRI64_PREFIX "u"

   SCNuFAST8 : aliased constant String := "hhu" & ASCII.NUL;  --  /usr/include/inttypes.h:252
   ...
   SCNo8 : aliased constant String := "hho" & ASCII.NUL;  --  /usr/include/inttypes.h:258
   SCNo16 : aliased constant String := "ho" & ASCII.NUL;  --  /usr/include/inttypes.h:259
   SCNo32 : aliased constant String := "o" & ASCII.NUL;  --  /usr/include/inttypes.h:260
   --  unsupported macro: SCNo64 __PRI64_PREFIX "o"

   SCNoLEAST8 : aliased constant String := "hho" & ASCII.NUL;  --  /usr/include/inttypes.h:263
   SCNoLEAST16 : aliased constant String := "ho" & ASCII.NUL;  --  /usr/include/inttypes.h:264
   SCNoLEAST32 : aliased constant String := "o" & ASCII.NUL;  --  /usr/include/inttypes.h:265
   --  unsupported macro: SCNoLEAST64 __PRI64_PREFIX "o"

   SCNoFAST8 : aliased constant String := "hho" & ASCII.NUL;  --  /usr/include/inttypes.h:268
   ...
   SCNx8 : aliased constant String := "hhx" & ASCII.NUL;  --  /usr/include/inttypes.h:274
   SCNx16 : aliased constant String := "hx" & ASCII.NUL;  --  /usr/include/inttypes.h:275
   SCNx32 : aliased constant String := "x" & ASCII.NUL;  --  /usr/include/inttypes.h:276
   --  unsupported macro: SCNx64 __PRI64_PREFIX "x"

   SCNxLEAST8 : aliased constant String := "hhx" & ASCII.NUL;  --  /usr/include/inttypes.h:279
   SCNxLEAST16 : aliased constant String := "hx" & ASCII.NUL;  --  /usr/include/inttypes.h:280
   SCNxLEAST32 : aliased constant String := "x" & ASCII.NUL;  --  /usr/include/inttypes.h:281
   --  unsupported macro: SCNxLEAST64 __PRI64_PREFIX "x"

   SCNxFAST8 : aliased constant String := "hhx" & ASCII.NUL;  --  /usr/include/inttypes.h:284
  ...
  -- Remainder.   
   type imaxdiv_t is record
      quot : aliased long;  -- /usr/include/inttypes.h:334
      c_rem : aliased long;  -- /usr/include/inttypes.h:335
   end record
   with Convention => C_Pass_By_Copy;  -- /usr/include/inttypes.h:336

  -- We have to define the `uintmax_t' type using `lldiv_t'.   
  -- Quotient.   
  -- Remainder.   
  -- Compute absolute value of N.   
   function imaxabs (uu_n : stdint_h.intmax_t) return stdint_h.intmax_t  -- /usr/include/inttypes.h:351
   with Import => True, 
        Convention => C, 
        External_Name => "imaxabs";

  -- Return the `imaxdiv_t' representation of the value of NUMER over DENOM.  
   function imaxdiv (uu_numer : stdint_h.intmax_t; uu_denom : stdint_h.intmax_t) return imaxdiv_t  -- /usr/include/inttypes.h:354
   with Import => True, 
        Convention => C, 
  ...
  -- Like `strtol' but convert to `intmax_t'.   
   function strtoimax
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      ...
      uu_base : int) return stdint_h.intmax_t  -- /usr/include/inttypes.h:358
   with Import => True, 
        Convention => C, 
  ...
  -- Like `strtoul' but convert to `uintmax_t'.   
   function strtoumax
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      uu_endptr : System.Address;
      uu_base : int) return stdint_h.uintmax_t  -- /usr/include/inttypes.h:362
   with Import => True, 
        Convention => C, 
  ...
  -- Like `wcstol' but convert to `intmax_t'.   
   function wcstoimax
     (uu_nptr : access uu_gwchar_t;
      uu_endptr : System.Address;
      uu_base : int) return stdint_h.intmax_t  -- /usr/include/inttypes.h:366
   with Import => True, 
        Convention => C, 
  ...
  -- Like `wcstoul' but convert to `uintmax_t'.   
   function wcstoumax
     (uu_nptr : access uu_gwchar_t;
      uu_endptr : System.Address;
      uu_base : int) return stdint_h.uintmax_t  -- /usr/include/inttypes.h:371
   with Import => True, 
        Convention => C, 
