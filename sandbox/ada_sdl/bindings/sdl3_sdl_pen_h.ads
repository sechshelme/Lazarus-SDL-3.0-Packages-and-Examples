...
package SDL3_SDL_pen_h is

   --  unsupported macro: SDL_PEN_MOUSEID ((SDL_MouseID)-2)
   --  unsupported macro: SDL_PEN_TOUCHID ((SDL_TouchID)-2)
   SDL_PEN_INPUT_DOWN : constant := (2 ** 0);  --  /usr/local/include/SDL3/SDL_pen.h:116
   SDL_PEN_INPUT_BUTTON_1 : constant := (2 ** 1);  --  /usr/local/include/SDL3/SDL_pen.h:117
   SDL_PEN_INPUT_BUTTON_2 : constant := (2 ** 2);  --  /usr/local/include/SDL3/SDL_pen.h:118
   SDL_PEN_INPUT_BUTTON_3 : constant := (2 ** 3);  --  /usr/local/include/SDL3/SDL_pen.h:119
   SDL_PEN_INPUT_BUTTON_4 : constant := (2 ** 4);  --  /usr/local/include/SDL3/SDL_pen.h:120
   SDL_PEN_INPUT_BUTTON_5 : constant := (2 ** 5);  --  /usr/local/include/SDL3/SDL_pen.h:121
   SDL_PEN_INPUT_ERASER_TIP : constant := (2 ** 30);  --  /usr/local/include/SDL3/SDL_pen.h:122
   SDL_PEN_INPUT_IN_PROXIMITY : constant := (2 ** 31);  --  /usr/local/include/SDL3/SDL_pen.h:123
  ...
  --  
   ...
   subtype SDL_PenID is SDL3_SDL_stdinc_h.Uint32;  -- /usr/local/include/SDL3/SDL_pen.h:93
  ...
  --  
   ...
   subtype SDL_PenInputFlags is SDL3_SDL_stdinc_h.Uint32;  -- /usr/local/include/SDL3/SDL_pen.h:114
  ...
  --  
   ...
   type SDL_PenAxis is 
     (SDL_PEN_AXIS_PRESSURE,
      ...
      SDL_PEN_AXIS_COUNT)
   with Convention => C;  -- /usr/local/include/SDL3/SDL_pen.h:140
  ...
  --  
   ...
   subtype SDL_PenDeviceType is int;
   SDL_PenDeviceType_SDL_PEN_DEVICE_TYPE_INVALID : constant SDL_PenDeviceType := -1;
   SDL_PenDeviceType_SDL_PEN_DEVICE_TYPE_UNKNOWN : constant SDL_PenDeviceType := 0;
   SDL_PenDeviceType_SDL_PEN_DEVICE_TYPE_DIRECT : constant SDL_PenDeviceType := 1;
   SDL_PenDeviceType_SDL_PEN_DEVICE_TYPE_INDIRECT : constant SDL_PenDeviceType := 2;  -- /usr/local/include/SDL3/SDL_pen.h:167
  ...
  --  
   ...
   function SDL_GetPenDeviceType (instance_id : SDL_PenID) return SDL_PenDeviceType  -- /usr/local/include/SDL3/SDL_pen.h:189
   with Import => True, 
        Convention => C, 
