...
package SDL3_SDL_hints_h is

   SDL_HINT_ALLOW_ALT_TAB_WHILE_GRABBED : aliased constant String := "SDL_ALLOW_ALT_TAB_WHILE_GRABBED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:66

   SDL_HINT_ANDROID_ALLOW_RECREATE_ACTIVITY : aliased constant String := "SDL_ANDROID_ALLOW_RECREATE_ACTIVITY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:86

   SDL_HINT_ANDROID_BLOCK_ON_PAUSE : aliased constant String := "SDL_ANDROID_BLOCK_ON_PAUSE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:101

   SDL_HINT_ANDROID_LOW_LATENCY_AUDIO : aliased constant String := "SDL_ANDROID_LOW_LATENCY_AUDIO" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:118

   SDL_HINT_ANDROID_TRAP_BACK_BUTTON : aliased constant String := "SDL_ANDROID_TRAP_BACK_BUTTON" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:141

   SDL_HINT_APP_ID : aliased constant String := "SDL_APP_ID" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:157

   SDL_HINT_APP_NAME : aliased constant String := "SDL_APP_NAME" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:175

   SDL_HINT_APPLE_TV_CONTROLLER_UI_EVENTS : aliased constant String := "SDL_APPLE_TV_CONTROLLER_UI_EVENTS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:198

   SDL_HINT_APPLE_TV_REMOTE_ALLOW_ROTATION : aliased constant String := "SDL_APPLE_TV_REMOTE_ALLOW_ROTATION" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:213

   SDL_HINT_AUDIO_ALSA_DEFAULT_DEVICE : aliased constant String := "SDL_AUDIO_ALSA_DEFAULT_DEVICE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:233

   SDL_HINT_AUDIO_ALSA_DEFAULT_PLAYBACK_DEVICE : aliased constant String := "SDL_AUDIO_ALSA_DEFAULT_PLAYBACK_DEVICE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:251

   SDL_HINT_AUDIO_ALSA_DEFAULT_RECORDING_DEVICE : aliased constant String := "SDL_AUDIO_ALSA_DEFAULT_RECORDING_DEVICE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:269

   SDL_HINT_AUDIO_CATEGORY : aliased constant String := "SDL_AUDIO_CATEGORY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:287

   SDL_HINT_AUDIO_CHANNELS : aliased constant String := "SDL_AUDIO_CHANNELS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:300

   SDL_HINT_AUDIO_DEVICE_APP_ICON_NAME : aliased constant String := "SDL_AUDIO_DEVICE_APP_ICON_NAME" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:323

   SDL_HINT_AUDIO_DEVICE_SAMPLE_FRAMES : aliased constant String := "SDL_AUDIO_DEVICE_SAMPLE_FRAMES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:345

   SDL_HINT_AUDIO_DEVICE_STREAM_NAME : aliased constant String := "SDL_AUDIO_DEVICE_STREAM_NAME" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:372

   SDL_HINT_AUDIO_DEVICE_STREAM_ROLE : aliased constant String := "SDL_AUDIO_DEVICE_STREAM_ROLE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:412

   SDL_HINT_AUDIO_DEVICE_RAW_STREAM : aliased constant String := "SDL_AUDIO_DEVICE_RAW_STREAM" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:432

   SDL_HINT_AUDIO_DISK_INPUT_FILE : aliased constant String := "SDL_AUDIO_DISK_INPUT_FILE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:443

   SDL_HINT_AUDIO_DISK_OUTPUT_FILE : aliased constant String := "SDL_AUDIO_DISK_OUTPUT_FILE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:454

   SDL_HINT_AUDIO_DISK_TIMESCALE : aliased constant String := "SDL_AUDIO_DISK_TIMESCALE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:467

   SDL_HINT_AUDIO_DRIVER : aliased constant String := "SDL_AUDIO_DRIVER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:481

   SDL_HINT_AUDIO_DUMMY_TIMESCALE : aliased constant String := "SDL_AUDIO_DUMMY_TIMESCALE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:494

   SDL_HINT_AUDIO_FORMAT : aliased constant String := "SDL_AUDIO_FORMAT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:521

   SDL_HINT_AUDIO_FREQUENCY : aliased constant String := "SDL_AUDIO_FREQUENCY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:534

   SDL_HINT_AUDIO_INCLUDE_MONITORS : aliased constant String := "SDL_AUDIO_INCLUDE_MONITORS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:557

   SDL_HINT_AUTO_UPDATE_JOYSTICKS : aliased constant String := "SDL_AUTO_UPDATE_JOYSTICKS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:572

   SDL_HINT_AUTO_UPDATE_SENSORS : aliased constant String := "SDL_AUTO_UPDATE_SENSORS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:587

   SDL_HINT_BMP_SAVE_LEGACY_FORMAT : aliased constant String := "SDL_BMP_SAVE_LEGACY_FORMAT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:610

   SDL_HINT_CAMERA_DRIVER : aliased constant String := "SDL_CAMERA_DRIVER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:626

   SDL_HINT_CPU_FEATURE_MASK : aliased constant String := "SDL_CPU_FEATURE_MASK" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:659

   SDL_HINT_JOYSTICK_DIRECTINPUT : aliased constant String := "SDL_JOYSTICK_DIRECTINPUT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:673

   SDL_HINT_FILE_DIALOG_DRIVER : aliased constant String := "SDL_FILE_DIALOG_DRIVER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:702

   SDL_HINT_DISPLAY_USABLE_BOUNDS : aliased constant String := "SDL_DISPLAY_USABLE_BOUNDS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:720

   SDL_HINT_INVALID_PARAM_CHECKS : aliased constant String := "SDL_INVALID_PARAM_CHECKS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:735

   SDL_HINT_EMSCRIPTEN_ASYNCIFY : aliased constant String := "SDL_EMSCRIPTEN_ASYNCIFY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:756

   SDL_HINT_EMSCRIPTEN_CANVAS_SELECTOR : aliased constant String := "SDL_EMSCRIPTEN_CANVAS_SELECTOR" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:767

   SDL_HINT_EMSCRIPTEN_KEYBOARD_ELEMENT : aliased constant String := "SDL_EMSCRIPTEN_KEYBOARD_ELEMENT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:788

   SDL_HINT_ENABLE_SCREEN_KEYBOARD : aliased constant String := "SDL_ENABLE_SCREEN_KEYBOARD" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:805

   SDL_HINT_EVDEV_DEVICES : aliased constant String := "SDL_EVDEV_DEVICES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:822

   SDL_HINT_EVENT_LOGGING : aliased constant String := "SDL_EVENT_LOGGING" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:846

   SDL_HINT_FORCE_RAISEWINDOW : aliased constant String := "SDL_FORCE_RAISEWINDOW" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:866

   SDL_HINT_FRAMEBUFFER_ACCELERATION : aliased constant String := "SDL_FRAMEBUFFER_ACCELERATION" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:887

   SDL_HINT_GAMECONTROLLERCONFIG : aliased constant String := "SDL_GAMECONTROLLERCONFIG" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:902

   SDL_HINT_GAMECONTROLLERCONFIG_FILE : aliased constant String := "SDL_GAMECONTROLLERCONFIG_FILE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:918

   SDL_HINT_GAMECONTROLLERTYPE : aliased constant String := "SDL_GAMECONTROLLERTYPE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:942

   SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES : aliased constant String := "SDL_GAMECONTROLLER_IGNORE_DEVICES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:960

   SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES_EXCEPT : aliased constant String := "SDL_GAMECONTROLLER_IGNORE_DEVICES_EXCEPT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:978

   SDL_HINT_GAMECONTROLLER_SENSOR_FUSION : aliased constant String := "SDL_GAMECONTROLLER_SENSOR_FUSION" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1001

   SDL_HINT_GDK_TEXTINPUT_DEFAULT_TEXT : aliased constant String := "SDL_GDK_TEXTINPUT_DEFAULT_TEXT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1013

   SDL_HINT_GDK_TEXTINPUT_DESCRIPTION : aliased constant String := "SDL_GDK_TEXTINPUT_DESCRIPTION" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1025

   SDL_HINT_GDK_TEXTINPUT_MAX_LENGTH : aliased constant String := "SDL_GDK_TEXTINPUT_MAX_LENGTH" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1040

   SDL_HINT_GDK_TEXTINPUT_SCOPE : aliased constant String := "SDL_GDK_TEXTINPUT_SCOPE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1056

   SDL_HINT_GDK_TEXTINPUT_TITLE : aliased constant String := "SDL_GDK_TEXTINPUT_TITLE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1067

   SDL_HINT_HIDAPI_LIBUSB : aliased constant String := "SDL_HIDAPI_LIBUSB" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1085

   SDL_HINT_HIDAPI_LIBUSB_GAMECUBE : aliased constant String := "SDL_HIDAPI_LIBUSB_GAMECUBE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1100

   SDL_HINT_HIDAPI_LIBUSB_WHITELIST : aliased constant String := "SDL_HIDAPI_LIBUSB_WHITELIST" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1118

   SDL_HINT_HIDAPI_UDEV : aliased constant String := "SDL_HIDAPI_UDEV" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1132

   SDL_HINT_GPU_DRIVER : aliased constant String := "SDL_GPU_DRIVER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1146

   SDL_HINT_HIDAPI_ENUMERATE_ONLY_CONTROLLERS : aliased constant String := "SDL_HIDAPI_ENUMERATE_ONLY_CONTROLLERS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1165

   SDL_HINT_HIDAPI_IGNORE_DEVICES : aliased constant String := "SDL_HIDAPI_IGNORE_DEVICES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1182

   SDL_HINT_IME_IMPLEMENTED_UI : aliased constant String := "SDL_IME_IMPLEMENTED_UI" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1205

   SDL_HINT_IOS_HIDE_HOME_INDICATOR : aliased constant String := "SDL_IOS_HIDE_HOME_INDICATOR" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1224

   SDL_HINT_JOYSTICK_ALLOW_BACKGROUND_EVENTS : aliased constant String := "SDL_JOYSTICK_ALLOW_BACKGROUND_EVENTS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1241

   SDL_HINT_JOYSTICK_ARCADESTICK_DEVICES : aliased constant String := "SDL_JOYSTICK_ARCADESTICK_DEVICES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1258

   SDL_HINT_JOYSTICK_ARCADESTICK_DEVICES_EXCLUDED : aliased constant String := "SDL_JOYSTICK_ARCADESTICK_DEVICES_EXCLUDED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1279

   SDL_HINT_JOYSTICK_BLACKLIST_DEVICES : aliased constant String := "SDL_JOYSTICK_BLACKLIST_DEVICES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1297

   SDL_HINT_JOYSTICK_BLACKLIST_DEVICES_EXCLUDED : aliased constant String := "SDL_JOYSTICK_BLACKLIST_DEVICES_EXCLUDED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1318

   SDL_HINT_JOYSTICK_DEVICE : aliased constant String := "SDL_JOYSTICK_DEVICE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1328

   SDL_HINT_JOYSTICK_ENHANCED_REPORTS : aliased constant String := "SDL_JOYSTICK_ENHANCED_REPORTS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1353

   SDL_HINT_JOYSTICK_FLIGHTSTICK_DEVICES : aliased constant String := "SDL_JOYSTICK_FLIGHTSTICK_DEVICES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1370

   SDL_HINT_JOYSTICK_FLIGHTSTICK_DEVICES_EXCLUDED : aliased constant String := "SDL_JOYSTICK_FLIGHTSTICK_DEVICES_EXCLUDED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1391

   SDL_HINT_JOYSTICK_GAMEINPUT : aliased constant String := "SDL_JOYSTICK_GAMEINPUT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1408

   SDL_HINT_JOYSTICK_GAMECUBE_DEVICES : aliased constant String := "SDL_JOYSTICK_GAMECUBE_DEVICES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1426

   SDL_HINT_JOYSTICK_GAMECUBE_DEVICES_EXCLUDED : aliased constant String := "SDL_JOYSTICK_GAMECUBE_DEVICES_EXCLUDED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1447

   SDL_HINT_JOYSTICK_HIDAPI : aliased constant String := "SDL_JOYSTICK_HIDAPI" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1464

   SDL_HINT_JOYSTICK_HIDAPI_COMBINE_JOY_CONS : aliased constant String := "SDL_JOYSTICK_HIDAPI_COMBINE_JOY_CONS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1481

   SDL_HINT_JOYSTICK_HIDAPI_GAMECUBE : aliased constant String := "SDL_JOYSTICK_HIDAPI_GAMECUBE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1498

   SDL_HINT_JOYSTICK_HIDAPI_GAMECUBE_RUMBLE_BRAKE : aliased constant String := "SDL_JOYSTICK_HIDAPI_GAMECUBE_RUMBLE_BRAKE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1519

   SDL_HINT_JOYSTICK_HIDAPI_JOY_CONS : aliased constant String := "SDL_JOYSTICK_HIDAPI_JOY_CONS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1536

   SDL_HINT_JOYSTICK_HIDAPI_JOYCON_HOME_LED : aliased constant String := "SDL_JOYSTICK_HIDAPI_JOYCON_HOME_LED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1555

   SDL_HINT_JOYSTICK_HIDAPI_LUNA : aliased constant String := "SDL_JOYSTICK_HIDAPI_LUNA" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1572

   SDL_HINT_JOYSTICK_HIDAPI_NINTENDO_CLASSIC : aliased constant String := "SDL_JOYSTICK_HIDAPI_NINTENDO_CLASSIC" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1589

   SDL_HINT_JOYSTICK_HIDAPI_PS3 : aliased constant String := "SDL_JOYSTICK_HIDAPI_PS3" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1611

   SDL_HINT_JOYSTICK_HIDAPI_PS3_SIXAXIS_DRIVER : aliased constant String := "SDL_JOYSTICK_HIDAPI_PS3_SIXAXIS_DRIVER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1628

   SDL_HINT_JOYSTICK_HIDAPI_PS4 : aliased constant String := "SDL_JOYSTICK_HIDAPI_PS4" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1645

   SDL_HINT_JOYSTICK_HIDAPI_PS4_REPORT_INTERVAL : aliased constant String := "SDL_JOYSTICK_HIDAPI_PS4_REPORT_INTERVAL" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1660

   SDL_HINT_JOYSTICK_HIDAPI_PS5 : aliased constant String := "SDL_JOYSTICK_HIDAPI_PS5" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1677

   SDL_HINT_JOYSTICK_HIDAPI_PS5_PLAYER_LED : aliased constant String := "SDL_JOYSTICK_HIDAPI_PS5_PLAYER_LED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1690

   SDL_HINT_JOYSTICK_HIDAPI_SHIELD : aliased constant String := "SDL_JOYSTICK_HIDAPI_SHIELD" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1707

   SDL_HINT_JOYSTICK_HIDAPI_STADIA : aliased constant String := "SDL_JOYSTICK_HIDAPI_STADIA" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1722

   SDL_HINT_JOYSTICK_HIDAPI_STEAM : aliased constant String := "SDL_JOYSTICK_HIDAPI_STEAM" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1739

   SDL_HINT_JOYSTICK_HIDAPI_STEAM_HOME_LED : aliased constant String := "SDL_JOYSTICK_HIDAPI_STEAM_HOME_LED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1758

   SDL_HINT_JOYSTICK_HIDAPI_STEAMDECK : aliased constant String := "SDL_JOYSTICK_HIDAPI_STEAMDECK" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1775

   SDL_HINT_JOYSTICK_HIDAPI_STEAM_HORI : aliased constant String := "SDL_JOYSTICK_HIDAPI_STEAM_HORI" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1792

   SDL_HINT_JOYSTICK_HIDAPI_LG4FF : aliased constant String := "SDL_JOYSTICK_HIDAPI_LG4FF" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1809

   SDL_HINT_JOYSTICK_HIDAPI_8BITDO : aliased constant String := "SDL_JOYSTICK_HIDAPI_8BITDO" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1826

   SDL_HINT_JOYSTICK_HIDAPI_SINPUT : aliased constant String := "SDL_JOYSTICK_HIDAPI_SINPUT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1845

   SDL_HINT_JOYSTICK_HIDAPI_ZUIKI : aliased constant String := "SDL_JOYSTICK_HIDAPI_ZUIKI" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1862

   SDL_HINT_JOYSTICK_HIDAPI_FLYDIGI : aliased constant String := "SDL_JOYSTICK_HIDAPI_FLYDIGI" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1879

   SDL_HINT_JOYSTICK_HIDAPI_SWITCH : aliased constant String := "SDL_JOYSTICK_HIDAPI_SWITCH" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1896

   SDL_HINT_JOYSTICK_HIDAPI_SWITCH_HOME_LED : aliased constant String := "SDL_JOYSTICK_HIDAPI_SWITCH_HOME_LED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1915

   SDL_HINT_JOYSTICK_HIDAPI_SWITCH_PLAYER_LED : aliased constant String := "SDL_JOYSTICK_HIDAPI_SWITCH_PLAYER_LED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1930

   SDL_HINT_JOYSTICK_HIDAPI_SWITCH2 : aliased constant String := "SDL_JOYSTICK_HIDAPI_SWITCH2" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1947

   SDL_HINT_JOYSTICK_HIDAPI_VERTICAL_JOY_CONS : aliased constant String := "SDL_JOYSTICK_HIDAPI_VERTICAL_JOY_CONS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1963

   SDL_HINT_JOYSTICK_HIDAPI_WII : aliased constant String := "SDL_JOYSTICK_HIDAPI_WII" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1981

   SDL_HINT_JOYSTICK_HIDAPI_WII_PLAYER_LED : aliased constant String := "SDL_JOYSTICK_HIDAPI_WII_PLAYER_LED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:1996

   SDL_HINT_JOYSTICK_HIDAPI_XBOX : aliased constant String := "SDL_JOYSTICK_HIDAPI_XBOX" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2014

   SDL_HINT_JOYSTICK_HIDAPI_XBOX_360 : aliased constant String := "SDL_JOYSTICK_HIDAPI_XBOX_360" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2031

   SDL_HINT_JOYSTICK_HIDAPI_XBOX_360_PLAYER_LED : aliased constant String := "SDL_JOYSTICK_HIDAPI_XBOX_360_PLAYER_LED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2046

   SDL_HINT_JOYSTICK_HIDAPI_XBOX_360_WIRELESS : aliased constant String := "SDL_JOYSTICK_HIDAPI_XBOX_360_WIRELESS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2063

   SDL_HINT_JOYSTICK_HIDAPI_XBOX_ONE : aliased constant String := "SDL_JOYSTICK_HIDAPI_XBOX_ONE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2080

   SDL_HINT_JOYSTICK_HIDAPI_XBOX_ONE_HOME_LED : aliased constant String := "SDL_JOYSTICK_HIDAPI_XBOX_ONE_HOME_LED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2099

   SDL_HINT_JOYSTICK_HIDAPI_GIP : aliased constant String := "SDL_JOYSTICK_HIDAPI_GIP" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2116

   SDL_HINT_JOYSTICK_HIDAPI_GIP_RESET_FOR_METADATA : aliased constant String := "SDL_JOYSTICK_HIDAPI_GIP_RESET_FOR_METADATA" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2134

   SDL_HINT_JOYSTICK_IOKIT : aliased constant String := "SDL_JOYSTICK_IOKIT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2149

   SDL_HINT_JOYSTICK_LINUX_CLASSIC : aliased constant String := "SDL_JOYSTICK_LINUX_CLASSIC" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2164

   SDL_HINT_JOYSTICK_LINUX_DEADZONES : aliased constant String := "SDL_JOYSTICK_LINUX_DEADZONES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2179

   SDL_HINT_JOYSTICK_LINUX_DIGITAL_HATS : aliased constant String := "SDL_JOYSTICK_LINUX_DIGITAL_HATS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2197

   SDL_HINT_JOYSTICK_LINUX_HAT_DEADZONES : aliased constant String := "SDL_JOYSTICK_LINUX_HAT_DEADZONES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2213

   SDL_HINT_JOYSTICK_MFI : aliased constant String := "SDL_JOYSTICK_MFI" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2228

   SDL_HINT_JOYSTICK_RAWINPUT : aliased constant String := "SDL_JOYSTICK_RAWINPUT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2243

   SDL_HINT_JOYSTICK_RAWINPUT_CORRELATE_XINPUT : aliased constant String := "SDL_JOYSTICK_RAWINPUT_CORRELATE_XINPUT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2260

   SDL_HINT_JOYSTICK_ROG_CHAKRAM : aliased constant String := "SDL_JOYSTICK_ROG_CHAKRAM" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2275

   SDL_HINT_JOYSTICK_THREAD : aliased constant String := "SDL_JOYSTICK_THREAD" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2290

   SDL_HINT_JOYSTICK_THROTTLE_DEVICES : aliased constant String := "SDL_JOYSTICK_THROTTLE_DEVICES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2307

   SDL_HINT_JOYSTICK_THROTTLE_DEVICES_EXCLUDED : aliased constant String := "SDL_JOYSTICK_THROTTLE_DEVICES_EXCLUDED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2328

   SDL_HINT_JOYSTICK_WGI : aliased constant String := "SDL_JOYSTICK_WGI" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2343

   SDL_HINT_JOYSTICK_WHEEL_DEVICES : aliased constant String := "SDL_JOYSTICK_WHEEL_DEVICES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2360

   SDL_HINT_JOYSTICK_WHEEL_DEVICES_EXCLUDED : aliased constant String := "SDL_JOYSTICK_WHEEL_DEVICES_EXCLUDED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2381

   SDL_HINT_JOYSTICK_ZERO_CENTERED_DEVICES : aliased constant String := "SDL_JOYSTICK_ZERO_CENTERED_DEVICES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2399

   SDL_HINT_JOYSTICK_HAPTIC_AXES : aliased constant String := "SDL_JOYSTICK_HAPTIC_AXES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2421

   SDL_HINT_KEYCODE_OPTIONS : aliased constant String := "SDL_KEYCODE_OPTIONS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2455

   SDL_HINT_KMSDRM_DEVICE_INDEX : aliased constant String := "SDL_KMSDRM_DEVICE_INDEX" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2469

   SDL_HINT_KMSDRM_REQUIRE_DRM_MASTER : aliased constant String := "SDL_KMSDRM_REQUIRE_DRM_MASTER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2497

   SDL_HINT_KMSDRM_ATOMIC : aliased constant String := "SDL_KMSDRM_ATOMIC" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2518

   SDL_HINT_LOGGING : aliased constant String := "SDL_LOGGING" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2549

   SDL_HINT_MAC_BACKGROUND_APP : aliased constant String := "SDL_MAC_BACKGROUND_APP" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2565

   SDL_HINT_MAC_CTRL_CLICK_EMULATE_RIGHT_CLICK : aliased constant String := "SDL_MAC_CTRL_CLICK_EMULATE_RIGHT_CLICK" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2581

   SDL_HINT_MAC_OPENGL_ASYNC_DISPATCH : aliased constant String := "SDL_MAC_OPENGL_ASYNC_DISPATCH" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2604

   SDL_HINT_MAC_OPTION_AS_ALT : aliased constant String := "SDL_MAC_OPTION_AS_ALT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2629

   SDL_HINT_MAC_SCROLL_MOMENTUM : aliased constant String := "SDL_MAC_SCROLL_MOMENTUM" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2644

   SDL_HINT_MAC_PRESS_AND_HOLD : aliased constant String := "SDL_MAC_PRESS_AND_HOLD" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2659

   SDL_HINT_MAIN_CALLBACK_RATE : aliased constant String := "SDL_MAIN_CALLBACK_RATE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2689

   SDL_HINT_MOUSE_AUTO_CAPTURE : aliased constant String := "SDL_MOUSE_AUTO_CAPTURE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2708

   SDL_HINT_MOUSE_DOUBLE_CLICK_RADIUS : aliased constant String := "SDL_MOUSE_DOUBLE_CLICK_RADIUS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2717

   SDL_HINT_MOUSE_DOUBLE_CLICK_TIME : aliased constant String := "SDL_MOUSE_DOUBLE_CLICK_TIME" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2726

   SDL_HINT_MOUSE_DEFAULT_SYSTEM_CURSOR : aliased constant String := "SDL_MOUSE_DEFAULT_SYSTEM_CURSOR" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2738

   SDL_HINT_MOUSE_DPI_SCALE_CURSORS : aliased constant String := "SDL_MOUSE_DPI_SCALE_CURSORS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2756

   SDL_HINT_MOUSE_EMULATE_WARP_WITH_RELATIVE : aliased constant String := "SDL_MOUSE_EMULATE_WARP_WITH_RELATIVE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2788

   SDL_HINT_MOUSE_FOCUS_CLICKTHROUGH : aliased constant String := "SDL_MOUSE_FOCUS_CLICKTHROUGH" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2802

   SDL_HINT_MOUSE_NORMAL_SPEED_SCALE : aliased constant String := "SDL_MOUSE_NORMAL_SPEED_SCALE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2812

   SDL_HINT_MOUSE_RELATIVE_MODE_CENTER : aliased constant String := "SDL_MOUSE_RELATIVE_MODE_CENTER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2833

   SDL_HINT_MOUSE_RELATIVE_SPEED_SCALE : aliased constant String := "SDL_MOUSE_RELATIVE_SPEED_SCALE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2843

   SDL_HINT_MOUSE_RELATIVE_SYSTEM_SCALE : aliased constant String := "SDL_MOUSE_RELATIVE_SYSTEM_SCALE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2862

   SDL_HINT_MOUSE_RELATIVE_WARP_MOTION : aliased constant String := "SDL_MOUSE_RELATIVE_WARP_MOTION" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2881

   SDL_HINT_MOUSE_RELATIVE_CURSOR_VISIBLE : aliased constant String := "SDL_MOUSE_RELATIVE_CURSOR_VISIBLE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2900

   SDL_HINT_MOUSE_TOUCH_EVENTS : aliased constant String := "SDL_MOUSE_TOUCH_EVENTS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2917

   SDL_HINT_MUTE_CONSOLE_KEYBOARD : aliased constant String := "SDL_MUTE_CONSOLE_KEYBOARD" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2935

   SDL_HINT_NO_SIGNAL_HANDLERS : aliased constant String := "SDL_NO_SIGNAL_HANDLERS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2950

   SDL_HINT_OPENGL_LIBRARY : aliased constant String := "SDL_OPENGL_LIBRARY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2961

   SDL_HINT_EGL_LIBRARY : aliased constant String := "SDL_EGL_LIBRARY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:2973

   SDL_HINT_OPENGL_ES_DRIVER : aliased constant String := "SDL_OPENGL_ES_DRIVER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3007

   SDL_HINT_OPENVR_LIBRARY : aliased constant String := "SDL_OPENVR_LIBRARY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3019

   SDL_HINT_ORIENTATIONS : aliased constant String := "SDL_ORIENTATIONS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3038

   SDL_HINT_POLL_SENTINEL : aliased constant String := "SDL_POLL_SENTINEL" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3058

   SDL_HINT_PREFERRED_LOCALES : aliased constant String := "SDL_PREFERRED_LOCALES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3076

   SDL_HINT_QUIT_ON_LAST_WINDOW_CLOSE : aliased constant String := "SDL_QUIT_ON_LAST_WINDOW_CLOSE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3099

   SDL_HINT_RENDER_DIRECT3D_THREADSAFE : aliased constant String := "SDL_RENDER_DIRECT3D_THREADSAFE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3114

   SDL_HINT_RENDER_DIRECT3D11_DEBUG : aliased constant String := "SDL_RENDER_DIRECT3D11_DEBUG" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3130

   SDL_HINT_RENDER_DIRECT3D11_WARP : aliased constant String := "SDL_RENDER_DIRECT3D11_WARP" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3148

   SDL_HINT_RENDER_VULKAN_DEBUG : aliased constant String := "SDL_RENDER_VULKAN_DEBUG" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3162

   SDL_HINT_RENDER_GPU_DEBUG : aliased constant String := "SDL_RENDER_GPU_DEBUG" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3176

   SDL_HINT_RENDER_GPU_LOW_POWER : aliased constant String := "SDL_RENDER_GPU_LOW_POWER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3191

   SDL_HINT_RENDER_DRIVER : aliased constant String := "SDL_RENDER_DRIVER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3224

   SDL_HINT_RENDER_LINE_METHOD : aliased constant String := "SDL_RENDER_LINE_METHOD" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3242

   SDL_HINT_RENDER_METAL_PREFER_LOW_POWER_DEVICE : aliased constant String := "SDL_RENDER_METAL_PREFER_LOW_POWER_DEVICE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3257

   SDL_HINT_RENDER_VSYNC : aliased constant String := "SDL_RENDER_VSYNC" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3274

   SDL_HINT_RETURN_KEY_HIDES_IME : aliased constant String := "SDL_RETURN_KEY_HIDES_IME" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3291

   SDL_HINT_ROG_GAMEPAD_MICE : aliased constant String := "SDL_ROG_GAMEPAD_MICE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3310

   SDL_HINT_ROG_GAMEPAD_MICE_EXCLUDED : aliased constant String := "SDL_ROG_GAMEPAD_MICE_EXCLUDED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3330

   SDL_HINT_PS2_GS_WIDTH : aliased constant String := "SDL_PS2_GS_WIDTH" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3339

   SDL_HINT_PS2_GS_HEIGHT : aliased constant String := "SDL_PS2_GS_HEIGHT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3348

   SDL_HINT_PS2_GS_PROGRESSIVE : aliased constant String := "SDL_PS2_GS_PROGRESSIVE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3360

   SDL_HINT_PS2_GS_MODE : aliased constant String := "SDL_PS2_GS_MODE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3373

   SDL_HINT_RPI_VIDEO_LAYER : aliased constant String := "SDL_RPI_VIDEO_LAYER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3385

   SDL_HINT_SCREENSAVER_INHIBIT_ACTIVITY_NAME : aliased constant String := "SDL_SCREENSAVER_INHIBIT_ACTIVITY_NAME" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3407

   SDL_HINT_SHUTDOWN_DBUS_ON_QUIT : aliased constant String := "SDL_SHUTDOWN_DBUS_ON_QUIT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3426

   SDL_HINT_STORAGE_TITLE_DRIVER : aliased constant String := "SDL_STORAGE_TITLE_DRIVER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3440

   SDL_HINT_STORAGE_USER_DRIVER : aliased constant String := "SDL_STORAGE_USER_DRIVER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3454

   SDL_HINT_THREAD_FORCE_REALTIME_TIME_CRITICAL : aliased constant String := "SDL_THREAD_FORCE_REALTIME_TIME_CRITICAL" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3483

   SDL_HINT_THREAD_PRIORITY_POLICY : aliased constant String := "SDL_THREAD_PRIORITY_POLICY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3506

   SDL_HINT_TIMER_RESOLUTION : aliased constant String := "SDL_TIMER_RESOLUTION" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3526

   SDL_HINT_TOUCH_MOUSE_EVENTS : aliased constant String := "SDL_TOUCH_MOUSE_EVENTS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3541

   SDL_HINT_TRACKPAD_IS_TOUCH_ONLY : aliased constant String := "SDL_TRACKPAD_IS_TOUCH_ONLY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3562

   SDL_HINT_TV_REMOTE_AS_JOYSTICK : aliased constant String := "SDL_TV_REMOTE_AS_JOYSTICK" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3577

   SDL_HINT_VIDEO_ALLOW_SCREENSAVER : aliased constant String := "SDL_VIDEO_ALLOW_SCREENSAVER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3591

   SDL_HINT_VIDEO_DISPLAY_PRIORITY : aliased constant String := "SDL_VIDEO_DISPLAY_PRIORITY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3618

   SDL_HINT_VIDEO_DOUBLE_BUFFER : aliased constant String := "SDL_VIDEO_DOUBLE_BUFFER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3641

   SDL_HINT_VIDEO_DRIVER : aliased constant String := "SDL_VIDEO_DRIVER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3659

   SDL_HINT_VIDEO_DUMMY_SAVE_FRAMES : aliased constant String := "SDL_VIDEO_DUMMY_SAVE_FRAMES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3672

   SDL_HINT_VIDEO_EGL_ALLOW_GETDISPLAY_FALLBACK : aliased constant String := "SDL_VIDEO_EGL_ALLOW_GETDISPLAY_FALLBACK" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3686

   SDL_HINT_VIDEO_FORCE_EGL : aliased constant String := "SDL_VIDEO_FORCE_EGL" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3702

   SDL_HINT_VIDEO_MAC_FULLSCREEN_SPACES : aliased constant String := "SDL_VIDEO_MAC_FULLSCREEN_SPACES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3720

   SDL_HINT_VIDEO_MAC_FULLSCREEN_MENU_VISIBILITY : aliased constant String := "SDL_VIDEO_MAC_FULLSCREEN_MENU_VISIBILITY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3741

   SDL_HINT_VIDEO_METAL_AUTO_RESIZE_DRAWABLE : aliased constant String := "SDL_VIDEO_METAL_AUTO_RESIZE_DRAWABLE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3758

   SDL_HINT_VIDEO_MATCH_EXCLUSIVE_MODE_ON_MOVE : aliased constant String := "SDL_VIDEO_MATCH_EXCLUSIVE_MODE_ON_MOVE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3778

   SDL_HINT_VIDEO_MINIMIZE_ON_FOCUS_LOSS : aliased constant String := "SDL_VIDEO_MINIMIZE_ON_FOCUS_LOSS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3796

   SDL_HINT_VIDEO_OFFSCREEN_SAVE_FRAMES : aliased constant String := "SDL_VIDEO_OFFSCREEN_SAVE_FRAMES" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3813

   SDL_HINT_VIDEO_SYNC_WINDOW_OPERATIONS : aliased constant String := "SDL_VIDEO_SYNC_WINDOW_OPERATIONS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3839

   SDL_HINT_VIDEO_WAYLAND_ALLOW_LIBDECOR : aliased constant String := "SDL_VIDEO_WAYLAND_ALLOW_LIBDECOR" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3857

   SDL_HINT_VIDEO_WAYLAND_MODE_EMULATION : aliased constant String := "SDL_VIDEO_WAYLAND_MODE_EMULATION" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3877

   SDL_HINT_VIDEO_WAYLAND_MODE_SCALING : aliased constant String := "SDL_VIDEO_WAYLAND_MODE_SCALING" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3899

   SDL_HINT_VIDEO_WAYLAND_PREFER_LIBDECOR : aliased constant String := "SDL_VIDEO_WAYLAND_PREFER_LIBDECOR" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3919

   SDL_HINT_VIDEO_WAYLAND_SCALE_TO_DISPLAY : aliased constant String := "SDL_VIDEO_WAYLAND_SCALE_TO_DISPLAY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3958

   SDL_HINT_VIDEO_WIN_D3DCOMPILER : aliased constant String := "SDL_VIDEO_WIN_D3DCOMPILER" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3980

   SDL_HINT_VIDEO_X11_EXTERNAL_WINDOW_INPUT : aliased constant String := "SDL_VIDEO_X11_EXTERNAL_WINDOW_INPUT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:3996

   SDL_HINT_VIDEO_X11_NET_WM_BYPASS_COMPOSITOR : aliased constant String := "SDL_VIDEO_X11_NET_WM_BYPASS_COMPOSITOR" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4011

   SDL_HINT_VIDEO_X11_NET_WM_PING : aliased constant String := "SDL_VIDEO_X11_NET_WM_PING" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4030

   SDL_HINT_VIDEO_X11_NODIRECTCOLOR : aliased constant String := "SDL_VIDEO_X11_NODIRECTCOLOR" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4044

   SDL_HINT_VIDEO_X11_SCALING_FACTOR : aliased constant String := "SDL_VIDEO_X11_SCALING_FACTOR" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4055

   SDL_HINT_VIDEO_X11_VISUALID : aliased constant String := "SDL_VIDEO_X11_VISUALID" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4064

   SDL_HINT_VIDEO_X11_WINDOW_VISUALID : aliased constant String := "SDL_VIDEO_X11_WINDOW_VISUALID" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4073

   SDL_HINT_VIDEO_X11_XRANDR : aliased constant String := "SDL_VIDEO_X11_XRANDR" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4087

   SDL_HINT_VITA_ENABLE_BACK_TOUCH : aliased constant String := "SDL_VITA_ENABLE_BACK_TOUCH" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4102

   SDL_HINT_VITA_ENABLE_FRONT_TOUCH : aliased constant String := "SDL_VITA_ENABLE_FRONT_TOUCH" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4117

   SDL_HINT_VITA_MODULE_PATH : aliased constant String := "SDL_VITA_MODULE_PATH" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4128

   SDL_HINT_VITA_PVR_INIT : aliased constant String := "SDL_VITA_PVR_INIT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4141

   SDL_HINT_VITA_RESOLUTION : aliased constant String := "SDL_VITA_RESOLUTION" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4156

   SDL_HINT_VITA_PVR_OPENGL : aliased constant String := "SDL_VITA_PVR_OPENGL" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4171

   SDL_HINT_VITA_TOUCH_MOUSE_DEVICE : aliased constant String := "SDL_VITA_TOUCH_MOUSE_DEVICE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4187

   SDL_HINT_VULKAN_DISPLAY : aliased constant String := "SDL_VULKAN_DISPLAY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4198

   SDL_HINT_VULKAN_LIBRARY : aliased constant String := "SDL_VULKAN_LIBRARY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4208

   SDL_HINT_WAVE_FACT_CHUNK : aliased constant String := "SDL_WAVE_FACT_CHUNK" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4240

   SDL_HINT_WAVE_CHUNK_LIMIT : aliased constant String := "SDL_WAVE_CHUNK_LIMIT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4252

   SDL_HINT_WAVE_RIFF_CHUNK_SIZE : aliased constant String := "SDL_WAVE_RIFF_CHUNK_SIZE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4280

   SDL_HINT_WAVE_TRUNCATION : aliased constant String := "SDL_WAVE_TRUNCATION" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4300

   SDL_HINT_WINDOW_ACTIVATE_WHEN_RAISED : aliased constant String := "SDL_WINDOW_ACTIVATE_WHEN_RAISED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4317

   SDL_HINT_WINDOW_ACTIVATE_WHEN_SHOWN : aliased constant String := "SDL_WINDOW_ACTIVATE_WHEN_SHOWN" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4334

   SDL_HINT_WINDOW_ALLOW_TOPMOST : aliased constant String := "SDL_WINDOW_ALLOW_TOPMOST" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4352

   SDL_HINT_WINDOW_FRAME_USABLE_WHILE_CURSOR_HIDDEN : aliased constant String := "SDL_WINDOW_FRAME_USABLE_WHILE_CURSOR_HIDDEN" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4368

   SDL_HINT_WINDOWS_CLOSE_ON_ALT_F4 : aliased constant String := "SDL_WINDOWS_CLOSE_ON_ALT_F4" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4384

   SDL_HINT_WINDOWS_ENABLE_MENU_MNEMONICS : aliased constant String := "SDL_WINDOWS_ENABLE_MENU_MNEMONICS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4413

   SDL_HINT_WINDOWS_ENABLE_MESSAGELOOP : aliased constant String := "SDL_WINDOWS_ENABLE_MESSAGELOOP" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4428

   SDL_HINT_WINDOWS_GAMEINPUT : aliased constant String := "SDL_WINDOWS_GAMEINPUT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4443

   SDL_HINT_WINDOWS_RAW_KEYBOARD : aliased constant String := "SDL_WINDOWS_RAW_KEYBOARD" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4457

   SDL_HINT_WINDOWS_RAW_KEYBOARD_EXCLUDE_HOTKEYS : aliased constant String := "SDL_WINDOWS_RAW_KEYBOARD_EXCLUDE_HOTKEYS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4479

   SDL_HINT_WINDOWS_FORCE_SEMAPHORE_KERNEL : aliased constant String := "SDL_WINDOWS_FORCE_SEMAPHORE_KERNEL" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4500

   SDL_HINT_WINDOWS_INTRESOURCE_ICON : aliased constant String := "SDL_WINDOWS_INTRESOURCE_ICON" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4510

   SDL_HINT_WINDOWS_INTRESOURCE_ICON_SMALL : aliased constant String := "SDL_WINDOWS_INTRESOURCE_ICON_SMALL" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4520

   SDL_HINT_WINDOWS_USE_D3D9EX : aliased constant String := "SDL_WINDOWS_USE_D3D9EX" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4546

   SDL_HINT_WINDOWS_ERASE_BACKGROUND_MODE : aliased constant String := "SDL_WINDOWS_ERASE_BACKGROUND_MODE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4563

   SDL_HINT_X11_FORCE_OVERRIDE_REDIRECT : aliased constant String := "SDL_X11_FORCE_OVERRIDE_REDIRECT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4584

   SDL_HINT_X11_WINDOW_TYPE : aliased constant String := "SDL_X11_WINDOW_TYPE" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4601

   SDL_HINT_X11_XCB_LIBRARY : aliased constant String := "SDL_X11_XCB_LIBRARY" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4612

   SDL_HINT_XINPUT_ENABLED : aliased constant String := "SDL_XINPUT_ENABLED" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4627

   SDL_HINT_ASSERT : aliased constant String := "SDL_ASSERT" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4651

   SDL_HINT_PEN_MOUSE_EVENTS : aliased constant String := "SDL_PEN_MOUSE_EVENTS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4666

   SDL_HINT_PEN_TOUCH_EVENTS : aliased constant String := "SDL_PEN_TOUCH_EVENTS" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_hints.h:4681
  ...
  --  
   ...
   type SDL_HintPriority is 
     (SDL_HINT_DEFAULT,
      SDL_HINT_NORMAL,
      SDL_HINT_OVERRIDE)
   with Convention => C;  -- /usr/local/include/SDL3/SDL_hints.h:4688
  ...
  --  
   ...
   function SDL_SetHintWithPriority
     (name : Interfaces.C.Strings.chars_ptr;
      ...
      priority : SDL_HintPriority) return Extensions.bool  -- /usr/local/include/SDL3/SDL_hints.h:4716
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_SetHint (name : Interfaces.C.Strings.chars_ptr; value : Interfaces.C.Strings.chars_ptr) return Extensions.bool  -- /usr/local/include/SDL3/SDL_hints.h:4738
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_ResetHint (name : Interfaces.C.Strings.chars_ptr) return Extensions.bool  -- /usr/local/include/SDL3/SDL_hints.h:4758
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_ResetHints  -- /usr/local/include/SDL3/SDL_hints.h:4773
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetHint (name : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr  -- /usr/local/include/SDL3/SDL_hints.h:4788
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetHintBoolean (name : Interfaces.C.Strings.chars_ptr; default_value : Extensions.bool) return Extensions.bool  -- /usr/local/include/SDL3/SDL_hints.h:4805
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   with Convention => C;  -- /usr/local/include/SDL3/SDL_hints.h:4827
  ...
  --  
   ...
   function SDL_AddHintCallback
     (name : Interfaces.C.Strings.chars_ptr;
      ...
      userdata : System.Address) return Extensions.bool  -- /usr/local/include/SDL3/SDL_hints.h:4848
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_RemoveHintCallback
     (name : Interfaces.C.Strings.chars_ptr;
      callback : SDL_HintCallback;
      userdata : System.Address)  -- /usr/local/include/SDL3/SDL_hints.h:4864
   with Import => True, 
        Convention => C, 
        External_Name => "SDL_RemoveHintCallback";

  -- Ends C function definitions when using C++  
end SDL3_SDL_hints_h;
