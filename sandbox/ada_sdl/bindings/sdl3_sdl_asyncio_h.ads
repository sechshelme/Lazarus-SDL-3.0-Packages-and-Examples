...
package SDL3_SDL_asyncio_h is
  ...
  --  
   ...
   type SDL_AsyncIO is null record;   -- incomplete struct
  ...
  --  
   ...
   type SDL_AsyncIOTaskType is 
     (SDL_ASYNCIO_TASK_READ,
      SDL_ASYNCIO_TASK_WRITE,
      SDL_ASYNCIO_TASK_CLOSE)
   with Convention => C;  -- /usr/local/include/SDL3/SDL_asyncio.h:131
  ...
  --  
   ...
   type SDL_AsyncIOResult is 
     (SDL_ASYNCIO_COMPLETE,
      SDL_ASYNCIO_FAILURE,
      SDL_ASYNCIO_CANCELED)
   with Convention => C;  -- /usr/local/include/SDL3/SDL_asyncio.h:143
  ...
  --*< what generated this task. This pointer will be invalid if it was closed!  
   type SDL_AsyncIOOutcome is record
      asyncio : access SDL_AsyncIO;  -- /usr/local/include/SDL3/SDL_asyncio.h:157
      c_type : aliased SDL_AsyncIOTaskType;  -- /usr/local/include/SDL3/SDL_asyncio.h:158
      result : aliased SDL_AsyncIOResult;  -- /usr/local/include/SDL3/SDL_asyncio.h:159
      buffer : System.Address;  -- /usr/local/include/SDL3/SDL_asyncio.h:160
      offset : aliased SDL3_SDL_stdinc_h.Uint64;  -- /usr/local/include/SDL3/SDL_asyncio.h:161
      bytes_requested : aliased SDL3_SDL_stdinc_h.Uint64;  -- /usr/local/include/SDL3/SDL_asyncio.h:162
      bytes_transferred : aliased SDL3_SDL_stdinc_h.Uint64;  -- /usr/local/include/SDL3/SDL_asyncio.h:163
      userdata : System.Address;  -- /usr/local/include/SDL3/SDL_asyncio.h:164
   end record
   with Convention => C_Pass_By_Copy;  -- /usr/local/include/SDL3/SDL_asyncio.h:155
  ...
  --  
   ...
   type SDL_AsyncIOQueue is null record;   -- incomplete struct
  ...
  --  
   ...
   function SDL_AsyncIOFromFile (file : Interfaces.C.Strings.chars_ptr; mode : Interfaces.C.Strings.chars_ptr) return access SDL_AsyncIO  -- /usr/local/include/SDL3/SDL_asyncio.h:222
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetAsyncIOSize (asyncio : access SDL_AsyncIO) return SDL3_SDL_stdinc_h.Sint64  -- /usr/local/include/SDL3/SDL_asyncio.h:239
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_ReadAsyncIO
     (asyncio : access SDL_AsyncIO;
      ptr : System.Address;
      offset : SDL3_SDL_stdinc_h.Uint64;
      size : SDL3_SDL_stdinc_h.Uint64;
      queue : access SDL_AsyncIOQueue;
      userdata : System.Address) return Extensions.bool  -- /usr/local/include/SDL3/SDL_asyncio.h:277
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_WriteAsyncIO
     (asyncio : access SDL_AsyncIO;
      ...
      size : SDL3_SDL_stdinc_h.Uint64;
      queue : access SDL_AsyncIOQueue;
      userdata : System.Address) return Extensions.bool  -- /usr/local/include/SDL3/SDL_asyncio.h:314
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CloseAsyncIO
     (asyncio : access SDL_AsyncIO;
      flush : Extensions.bool;
      queue : access SDL_AsyncIOQueue;
      userdata : System.Address) return Extensions.bool  -- /usr/local/include/SDL3/SDL_asyncio.h:363
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_CreateAsyncIOQueue return access SDL_AsyncIOQueue  -- /usr/local/include/SDL3/SDL_asyncio.h:382
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_DestroyAsyncIOQueue (queue : access SDL_AsyncIOQueue)  -- /usr/local/include/SDL3/SDL_asyncio.h:412
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetAsyncIOResult (queue : access SDL_AsyncIOQueue; outcome : access SDL_AsyncIOOutcome) return Extensions.bool  -- /usr/local/include/SDL3/SDL_asyncio.h:438
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_WaitAsyncIOResult
     (queue : access SDL_AsyncIOQueue;
      outcome : access SDL_AsyncIOOutcome;
      timeoutMS : SDL3_SDL_stdinc_h.Sint32) return Extensions.bool  -- /usr/local/include/SDL3/SDL_asyncio.h:482
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_SignalAsyncIOQueue (queue : access SDL_AsyncIOQueue)  -- /usr/local/include/SDL3/SDL_asyncio.h:506
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_LoadFileAsync
     (file : Interfaces.C.Strings.chars_ptr;
      queue : access SDL_AsyncIOQueue;
      userdata : System.Address) return Extensions.bool  -- /usr/local/include/SDL3/SDL_asyncio.h:538
   with Import => True, 
        Convention => C, 
        External_Name => "SDL_LoadFileAsync";

  -- Ends C function definitions when using C++  
end SDL3_SDL_asyncio_h;
