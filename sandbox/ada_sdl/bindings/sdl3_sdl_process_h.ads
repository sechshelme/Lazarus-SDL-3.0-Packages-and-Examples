...
package SDL3_SDL_process_h is

   SDL_PROP_PROCESS_CREATE_ARGS_POINTER : aliased constant String := "SDL.process.create.args" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:229
   SDL_PROP_PROCESS_CREATE_ENVIRONMENT_POINTER : aliased constant String := "SDL.process.create.environment" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:230
   SDL_PROP_PROCESS_CREATE_WORKING_DIRECTORY_STRING : aliased constant String := "SDL.process.create.working_directory" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:231
   SDL_PROP_PROCESS_CREATE_STDIN_NUMBER : aliased constant String := "SDL.process.create.stdin_option" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:232
   SDL_PROP_PROCESS_CREATE_STDIN_POINTER : aliased constant String := "SDL.process.create.stdin_source" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:233
   SDL_PROP_PROCESS_CREATE_STDOUT_NUMBER : aliased constant String := "SDL.process.create.stdout_option" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:234
   SDL_PROP_PROCESS_CREATE_STDOUT_POINTER : aliased constant String := "SDL.process.create.stdout_source" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:235
   SDL_PROP_PROCESS_CREATE_STDERR_NUMBER : aliased constant String := "SDL.process.create.stderr_option" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:236
   SDL_PROP_PROCESS_CREATE_STDERR_POINTER : aliased constant String := "SDL.process.create.stderr_source" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:237
   SDL_PROP_PROCESS_CREATE_STDERR_TO_STDOUT_BOOLEAN : aliased constant String := "SDL.process.create.stderr_to_stdout" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:238
   SDL_PROP_PROCESS_CREATE_BACKGROUND_BOOLEAN : aliased constant String := "SDL.process.create.background" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:239
   SDL_PROP_PROCESS_CREATE_CMDLINE_STRING : aliased constant String := "SDL.process.create.cmdline" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:240

   SDL_PROP_PROCESS_PID_NUMBER : aliased constant String := "SDL.process.pid" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:273
   SDL_PROP_PROCESS_STDIN_POINTER : aliased constant String := "SDL.process.stdin" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:274
   SDL_PROP_PROCESS_STDOUT_POINTER : aliased constant String := "SDL.process.stdout" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:275
   SDL_PROP_PROCESS_STDERR_POINTER : aliased constant String := "SDL.process.stderr" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:276
   SDL_PROP_PROCESS_BACKGROUND_BOOLEAN : aliased constant String := "SDL.process.background" & ASCII.NUL;  --  /usr/local/include/SDL3/SDL_process.h:277
  ...
  --  
   ...
   type SDL_Process is null record;   -- incomplete struct
  ...
  --  
   ...
   function SDL_CreateProcess (args : System.Address; pipe_stdio : Extensions.bool) return access SDL_Process  -- /usr/local/include/SDL3/SDL_process.h:106
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   type SDL_ProcessIO is 
     (SDL_PROCESS_STDIO_INHERITED,
      SDL_PROCESS_STDIO_NULL,
      SDL_PROCESS_STDIO_APP,
      SDL_PROCESS_STDIO_REDIRECT)
   with Convention => C;  -- /usr/local/include/SDL3/SDL_process.h:150
  ...
  --  
   ...
   function SDL_CreateProcessWithProperties (props : SDL3_SDL_properties_h.SDL_PropertiesID) return access SDL_Process  -- /usr/local/include/SDL3/SDL_process.h:227
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetProcessProperties (process : access SDL_Process) return SDL3_SDL_properties_h.SDL_PropertiesID  -- /usr/local/include/SDL3/SDL_process.h:271
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_ReadProcess
     (process : access SDL_Process;
      datasize : access stddef_h.size_t;
      exitcode : access int) return System.Address  -- /usr/local/include/SDL3/SDL_process.h:308
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetProcessInput (process : access SDL_Process) return access SDL3_SDL_iostream_h.SDL_IOStream  -- /usr/local/include/SDL3/SDL_process.h:334
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetProcessOutput (process : access SDL_Process) return access SDL3_SDL_iostream_h.SDL_IOStream  -- /usr/local/include/SDL3/SDL_process.h:358
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_KillProcess (process : access SDL_Process; force : Extensions.bool) return Extensions.bool  -- /usr/local/include/SDL3/SDL_process.h:381
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_WaitProcess
     (process : access SDL_Process;
      block : Extensions.bool;
      exitcode : access int) return Extensions.bool  -- /usr/local/include/SDL3/SDL_process.h:414
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_DestroyProcess (process : access SDL_Process)  -- /usr/local/include/SDL3/SDL_process.h:433
   with Import => True, 
        Convention => C, 
        External_Name => "SDL_DestroyProcess";

  -- Ends C function definitions when using C++  
end SDL3_SDL_process_h;
