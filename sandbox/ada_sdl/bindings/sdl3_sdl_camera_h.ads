...
package SDL3_SDL_camera_h is
  ...
  --  
   ...
   subtype SDL_CameraID is SDL3_SDL_stdinc_h.Uint32;  -- /usr/local/include/SDL3/SDL_camera.h:95
  ...
  --  
   ...
   type SDL_Camera is null record;   -- incomplete struct
  ...
  --*< Frame format  
   type SDL_CameraSpec is record
      format : aliased SDL3_SDL_pixels_h.SDL_PixelFormat;  -- /usr/local/include/SDL3/SDL_camera.h:117
      colorspace : aliased SDL3_SDL_pixels_h.SDL_Colorspace;  -- /usr/local/include/SDL3/SDL_camera.h:118
      width : aliased int;  -- /usr/local/include/SDL3/SDL_camera.h:119
      height : aliased int;  -- /usr/local/include/SDL3/SDL_camera.h:120
      framerate_numerator : aliased int;  -- /usr/local/include/SDL3/SDL_camera.h:121
      framerate_denominator : aliased int;  -- /usr/local/include/SDL3/SDL_camera.h:122
   end record
   with Convention => C_Pass_By_Copy;  -- /usr/local/include/SDL3/SDL_camera.h:115
  ...
  --  
   ...
   type SDL_CameraPosition is 
     (SDL_CAMERA_POSITION_UNKNOWN,
      SDL_CAMERA_POSITION_FRONT_FACING,
      SDL_CAMERA_POSITION_BACK_FACING)
   with Convention => C;  -- /usr/local/include/SDL3/SDL_camera.h:132
  ...
  --  
   ...
   subtype SDL_CameraPermissionState is int;
   SDL_CameraPermissionState_SDL_CAMERA_PERMISSION_STATE_DENIED : constant SDL_CameraPermissionState := -1;
   SDL_CameraPermissionState_SDL_CAMERA_PERMISSION_STATE_PENDING : constant SDL_CameraPermissionState := 0;
   SDL_CameraPermissionState_SDL_CAMERA_PERMISSION_STATE_APPROVED : constant SDL_CameraPermissionState := 1;  -- /usr/local/include/SDL3/SDL_camera.h:146
  ...
  --  
   ...
   function SDL_GetNumCameraDrivers return int  -- /usr/local/include/SDL3/SDL_camera.h:175
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCameraDriver (index : int) return Interfaces.C.Strings.chars_ptr  -- /usr/local/include/SDL3/SDL_camera.h:199
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCurrentCameraDriver return Interfaces.C.Strings.chars_ptr  -- /usr/local/include/SDL3/SDL_camera.h:215
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCameras (count : access int) return access SDL_CameraID  -- /usr/local/include/SDL3/SDL_camera.h:232
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCameraSupportedFormats (instance_id : SDL_CameraID; count : access int) return System.Address  -- /usr/local/include/SDL3/SDL_camera.h:271
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCameraName (instance_id : SDL_CameraID) return Interfaces.C.Strings.chars_ptr  -- /usr/local/include/SDL3/SDL_camera.h:286
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCameraPosition (instance_id : SDL_CameraID) return SDL_CameraPosition  -- /usr/local/include/SDL3/SDL_camera.h:305
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_OpenCamera (instance_id : SDL_CameraID; spec : access constant SDL_CameraSpec) return access SDL_Camera  -- /usr/local/include/SDL3/SDL_camera.h:352
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCameraPermissionState (camera : access SDL_Camera) return SDL_CameraPermissionState  -- /usr/local/include/SDL3/SDL_camera.h:387
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCameraID (camera : access SDL_Camera) return SDL_CameraID  -- /usr/local/include/SDL3/SDL_camera.h:402
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCameraProperties (camera : access SDL_Camera) return SDL3_SDL_properties_h.SDL_PropertiesID  -- /usr/local/include/SDL3/SDL_camera.h:415
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetCameraFormat (camera : access SDL_Camera; spec : access SDL_CameraSpec) return Extensions.bool  -- /usr/local/include/SDL3/SDL_camera.h:441
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_AcquireCameraFrame (camera : access SDL_Camera; timestampNS : access SDL3_SDL_stdinc_h.Uint64) return access SDL3_SDL_surface_h.SDL_Surface  -- /usr/local/include/SDL3/SDL_camera.h:484
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_ReleaseCameraFrame (camera : access SDL_Camera; frame : access SDL3_SDL_surface_h.SDL_Surface)  -- /usr/local/include/SDL3/SDL_camera.h:512
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure SDL_CloseCamera (camera : access SDL_Camera)  -- /usr/local/include/SDL3/SDL_camera.h:527
   with Import => True, 
        Convention => C, 
        External_Name => "SDL_CloseCamera";

  -- Ends C function definitions when using C++  
end SDL3_SDL_camera_h;
