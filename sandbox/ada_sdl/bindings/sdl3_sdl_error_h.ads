...
package SDL3_SDL_error_h is
  ...
  --  
   ...
   function SDL_SetError (fmt : Interfaces.C.Strings.chars_ptr  -- , ...
      ) return Extensions.bool  -- /usr/local/include/SDL3/SDL_error.h:89
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_SetErrorV (fmt : Interfaces.C.Strings.chars_ptr; ap : access System.Address) return Extensions.bool  -- /usr/local/include/SDL3/SDL_error.h:108
   with Import => True, 
        Convention => C, 
        External_Name => "SDL_SetErrorV";
  ...
  --  
   ...
   function SDL_OutOfMemory return Extensions.bool  -- /usr/local/include/SDL3/SDL_error.h:121
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_GetError return Interfaces.C.Strings.chars_ptr  -- /usr/local/include/SDL3/SDL_error.h:158
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function SDL_ClearError return Extensions.bool  -- /usr/local/include/SDL3/SDL_error.h:172
   with Import => True, 
        Convention => C, 
